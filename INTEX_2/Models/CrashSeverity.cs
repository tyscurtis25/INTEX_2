...
namespace INTEX_2.Models
{
    public class CrashSeverity
    {
        ...
        public Tensor<float> AsTensor()
        {
            ...
            {
                Lat_utm_y, Long_utm_x,  Intersection_Related_True,
                Teenage_driver_involved_true, Older_driver_involved_true, Night_dark_condition_true,
                Single_vehicle_true, Roadway_departure_true, Route_15, Route_Other, Main_road_name_Other, Main_road_name_I15,
                Crash_severity_id, Hour_17, Month_1, County_name_UTAH, 
